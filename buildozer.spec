...
requirements = python3, kivy==2.3.1, https://github.com/kivymd/KivyMD/archive/refs/tags/1.2.0.zip, exceptiongroup, asynckivy, asyncgui, materialyoucolor, android, materialshapes, pycairo, arabic-reshaper, python-bidi, plyer
